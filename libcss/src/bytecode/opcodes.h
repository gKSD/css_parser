...
enum op_background_size {
	...
	BACKGROUND_SIZE_AUTO	= 0x0003,
	BACKGROUND_SIZE_VALUE	= 0x0004,
	BACKGROUND_SIZE_END		= 0x0005
};
...
enum op_border_radius {
	BORDER_RADIUS_SET				= 0x0000,
	BORDER_RADIUS_END				= 0x0001,
	BORDER_RADIUS_DIMENSION_VALUE	= 0x0002,
	BORDER_RADIUS_NUMBER_VALUE		= 0x0003
};
...
enum op_hyphens {
	HYPHENS_AUTO		= 0x0000,
	HYPHENS_MANUAL		= 0x0001,
	HYPHENS_NONE		= 0x0002,
	HYPHENS_UNSET		= 0x0003,
	HYPHENS_INITIAL		= 0x0004
};
...
enum op_media_feature_orientation {
	MEDIA_FEATURE_ORIENTATION_LANDSCAPE			= 0x0000,
	MEDIA_FEATURE_ORIENTATION_PORTRAIT			= 0x0001
};

enum op_media_feature_overflow_inline {
	MEDIA_FEATURE_OVERFLOW_INLINE_NONE			= 0x0000,
	MEDIA_FEATURE_OVERFLOW_INLINE_SCROLL		= 0x0001
};

enum op_media_feature_scan {
	MEDIA_FEATURE_SCAN_PROGRESSIVE			= 0x0000,
	MEDIA_FEATURE_SCAN_INTERLACE			= 0x0001
};

enum op_media_feature_update_frequency {
	MEDIA_FEATURE_UPDATE_FREQUENCY_NONE		= 0x0000,
	MEDIA_FEATURE_UPDATE_FREQUENCY_SLOW		= 0x0001,
	MEDIA_FEATURE_UPDATE_FREQUENCY_FAST		= 0x0002
};

enum op_media_feature_overflow_block {
	MEDIA_FEATURE_OVERFLOW_BLOCK_NONE					= 0x0000,
	MEDIA_FEATURE_OVERFLOW_BLOCK_SCROLL					= 0x0001,
	MEDIA_FEATURE_OVERFLOW_BLOCK_OPTIONAL_PAGED			= 0x0002,
	MEDIA_FEATURE_OVERFLOW_BLOCK_PAGED					= 0x0003
};

// media features where no MEDIA_FEATURE_XXX_SET defined
// always have values
enum op_media_feature_color {
	MEDIA_FEATURE_COLOR_NO_VALUE		= 0x0000,
	MEDIA_FEATURE_COLOR_SET				= 0x0080
};

enum op_media_feature_color_index {
	MEDIA_FEATURE_COLOR_INDEX_NO_VALUE		= MEDIA_FEATURE_COLOR_NO_VALUE,
	MEDIA_FEATURE_COLOR_INDEX_SET			= MEDIA_FEATURE_COLOR_SET
};
enum op_media_feature_grid {
	MEDIA_FEATURE_GRID_NO_VALUE			= MEDIA_FEATURE_COLOR_NO_VALUE,
	MEDIA_FEATURE_GRID_SET				= MEDIA_FEATURE_COLOR_SET
};
enum op_media_feature_monochrome {
	MEDIA_FEATURE_MONOCHROME_NO_VALUE		= MEDIA_FEATURE_COLOR_NO_VALUE,
	MEDIA_FEATURE_MONOCHROME_SET			= MEDIA_FEATURE_COLOR_SET
};
