...
#include "../include/libcss/errors.h"
#include "../include/libcss/functypes.h"
#include "../include/libcss/stylesheet.h"
...
static inline css_error css__stylesheet_style_appendOPV(css_style *style, 
		uint16_t opcode, uint8_t flags, uint16_t value)
{
...
css_error css__stylesheet_rule_set_nascent_import(css_stylesheet *sheet,
		css_rule *rule, lwc_string *url, css_media_query *media);
...
bool css__stylesheet_media_query_applies_to_media(uint64_t applicable_media,
		css_media_query *media);
