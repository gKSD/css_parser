...
#include "../../../libparserutils/include/parserutils/charset/utf8.h"
#include "../../../libparserutils/include/parserutils/input/inputstream.h"
#include "../../../libparserutils/include/parserutils/utils/buffer.h"
...
#ifndef NDEBUG
		if (type != CSS_TOKEN_EOF && error != PARSERUTILS_OK)
			return CSS_INVALID;
#else
		(void) error;
#endif
